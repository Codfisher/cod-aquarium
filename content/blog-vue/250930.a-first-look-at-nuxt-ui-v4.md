...
Nuxt UI 真低不錯，可以嘗試看看，配合 MCP 與 LLMs.txt，入門門檻應該下降許多
...
只能固定右下角，[官方說](https://github.com/nuxt/ui/issues/808) Headless UI 和 Radix Vue 都不支援，所以我們沒有計畫支援 %…(°c＿,°`)%
...
Nuxt UI v4 整體很不錯，不過有一個小小遺憾，就是[不能使用 UnoCSS](https://github.com/nuxt/ui/issues/196) %( ˘･з･)%
