...
[Data Loader](https://router.vuejs.org/data-loaders/) 是 `unplugin-vue-router` 提供的功能，核心精神是**讓「資料請求」與元件同檔共存，卻不受元件生命週期束縛，由路由在換頁前提早平行觸發**。

如此一來，Loader 一樣寫在子元件檔案中，不需要拉到父元件，資料歸屬一目了然，元件獨立性完整保留。

::: tip Data Loader 詳細說明
由於這篇文章並非介紹 Data Loader，關於 Data Loader 具體用法與詳細說明，還請大家參考[官方文件](https://router.vuejs.org/data-loaders/)。
:::
