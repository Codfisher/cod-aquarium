---
title: 懶也是有好處的啦，試試 Remeda 的 lazy evaluator
...
# 懶也是有好處的啦，試試 Remeda 的 lazy evaluator

故事發生於某天平凡的午後，鱈魚我和平常一樣快樂地用著 [`Remeda`](https://remedajs.com/)，在使用 [`take`](https://github.com/remeda/remeda/blob/main/packages/remeda/src/take.ts) 時忽然很好奇原始碼如何實作。
...
至於甚麼是「惰性求值」，網路上超多文章，這裡就不贅述了。%(ゝ∀・)y%
