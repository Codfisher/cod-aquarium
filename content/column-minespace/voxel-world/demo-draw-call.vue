<template>
  <compare-grid
    ...
    caption="兩邊畫出來的方塊完全一樣多，差別只在左邊每一顆都是獨立的網格、右邊全部是同一個網格的 thin instance。把數量拉上去，看左邊的繪製呼叫怎麼跟著走。"
  >
    <demo-frame
...
/** 上限先全部建好，滑桿只決定顯示前幾顆，才不必每次重建整個場景 */
 ...
 * 讀繪製呼叫
 *
 * 量測本身也要花時間，所以只有這個範例掛它。
 * 每 0.4 秒更新一次，數字才不會閃到看不清楚
 */
