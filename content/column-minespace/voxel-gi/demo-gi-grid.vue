<template>
  <demo-frame
    ...
    :badge="badge"
    title="把世界降採樣成粗網格"
    caption="一格粗格記兩件事，這裡大致是實心的還是開放的、以及這裡的反照色大致是什麼。切到天空可見度能看到「上面壓了幾層實心」怎麼把天光收掉。垂直格距預設是 2，懸空那塊只有一格厚的石板在粗格裡恰好卡在一半，過不了半數門檻，切不出陰影；把垂直格距拉到最細的 1，石板才會整格判成實心，正下方那幾格的可見度從 1.0 掉到 0.7。"
