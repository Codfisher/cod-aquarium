...
一片晴天固然美好，但如果能下場雨就更有味道了。

雨打在屋頂、落在森林、流過草地，搭配前面做的聲景系統，整個氣氛瞬間不同。

這章來實作天氣系統：GPU 粒子雨滴、射線投射水花、以及動態的光照與霧氣變化。<span class="text-nowrap">%੭ ˙ᗜ˙ )੭%</span>
...
隨機降雨模式每 5 分鐘擲一次骰子，50% 機率下雨。你永遠不知道下一場雨什麼時候來。<span class="text-nowrap">ˋ( ° ▽、° )</span>
...
這樣水花就會精確地出現在積木頂部、地面上，而不會浮在空中。<span class="text-nowrap">%✧⁑｡٩(ˊᗜˋ\*)و✧⁕｡%</span>
...
水花延遲 3 秒才開始，因為雨滴需要時間「落下來」。<span class="text-nowrap">( •̀ ω •́ )✧</span>
...
使用 Vue 的 `effectScope` 確保清理時不會留下殘餘的 watcher。
...
下一章讓我們來看積木選擇器與縮圖生成機制吧。<span class="text-nowrap">♪( ◜ω◝و(و</span>
