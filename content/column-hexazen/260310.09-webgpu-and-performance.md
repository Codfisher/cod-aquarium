...
從渲染引擎的選擇到鏡頭限制、字體載入，這些看似微小的優化加在一起，就是「流暢」和「卡頓」的差別。%੭ ˙ᗜ˙ )੭%
...
`TRILINEAR_SAMPLINGMODE` 讓紋理邊緣被柔化，旋轉時不會有像素閃爍（z-fighting 的親戚）。%( •̀ ω •́ )✧%
...
每個 domain 自成一體，透過 composable 和 props 串接。%✧⁑｡٩(ˊᗜˋ\*)و✧⁕｡%
...
感謝看到這裡的你！希望這系列文章能給你一些靈感。%ヾ(◍'౪`◍)ﾉﾞ%
