/** 穿插在圖片清單中的廣告列高度（px）。
 * 280px 放得下 300x250 與 336x280 這類方形版位，單價明顯高於橫幅，
 * 而且它跟著清單捲動、不常駐版面，不必為了省空間壓到只剩橫幅高度
 */
