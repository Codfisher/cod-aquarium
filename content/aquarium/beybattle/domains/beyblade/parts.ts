...
export const attackRingPartList: PartDefinition[] = [
  {
    ...
    statsModifier: { attack: 8, defense: 2, stamina: 3, speed: 5, critical: 4 },
  ...
  },
  {
    ...
    category: PartCategory.ATTACK_RING,
    statsModifier: { attack: 3, defense: 6, stamina: 6, speed: 4, critical: 1 },
    collisionRadius: 0.5,
  ...
  },
  {
    ...
    category: PartCategory.ATTACK_RING,
    statsModifier: { attack: 10, defense: 1, stamina: 2, speed: 6, critical: 7 },
    collisionRadius: 0.6,
  ...
  },
  {
    ...
    category: PartCategory.ATTACK_RING,
    statsModifier: { attack: 5, defense: 4, stamina: 5, speed: 3, critical: 3 },
    collisionRadius: 0.55,
