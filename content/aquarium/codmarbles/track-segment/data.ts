...
export const trackSegmentData: Record<TrackSegmentType, TrackSegmentSceneData> = {
  ...
  [TrackSegmentType.b01]: {
    ...
    partList: [
      ...
      },
      {
        ...
        position: [3.144008, 14.574745, 3.000044],
      ...
      {
        path: 'blue/signage_arrows_left_blue.gltf',
        position: [-9.05349, 8.744234, -2.999969],
        rotationQuaternion: [-0.49999249, 0.50000225, -0.50000298, 0.50000228],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
  ...
  [TrackSegmentType.b02]: {
    ...
    partList: [
      ...
      {
        path: 'blue/platform_decorative_2x2x2_blue.gltf',
        position: [-5.750077, 15.179465, -0.828985],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'blue/platform_decorative_2x2x2_blue.gltf',
        position: [1.000693, 17.461311, -0.853534],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'blue/platform_decorative_2x2x2_blue.gltf',
        position: [-11.239017, 10.058865, -7.2946],
        rotationQuaternion: [0, 0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'blue/platform_decorative_2x2x2_blue.gltf',
        position: [-11.245647, 12.269057, -0.886513],
        rotationQuaternion: [0, 0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'blue/platform_decorative_2x2x2_blue.gltf',
        position: [-11.258362, 7.566597, -12.21961],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'blue/platform_decorative_2x2x2_blue.gltf',
        position: [-4.921282, 5.277301, -12.228065],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'blue/platform_decorative_2x2x2_blue.gltf',
        position: [0.005951, 2.695889, -11.779454],
        rotationQuaternion: [0, 0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'blue/platform_decorative_2x2x2_blue.gltf',
        position: [0.045616, 0.713762, -6.028399],
        rotationQuaternion: [0, 0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      },
      {
        ...
        position: [2.348835, 20.357826, -1.76531],
      ...
      {
        path: 'neutral/barrier_2x1x1.gltf',
        position: [0.816449, 22.017776, -1.42664],
        rotationQuaternion: [-0.13052618, 0.99144486, 2e-8, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/barrier_2x1x1.gltf',
        position: [-13.666583, 15.701563, -2.131235],
        rotationQuaternion: [-0.09229597, -0.70105738, 0.09229594, 0.70105738],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'neutral/barrier_2x1x1.gltf',
        position: [-10.268264, 11.040841, -14.793118],
        rotationQuaternion: [0.13052619, 0.99144486, 3e-8, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'neutral/barrier_2x1x1.gltf',
        position: [2.50052, 6.223044, -11.041564],
  ...
  [TrackSegmentType.y01]: {
    ...
    partList: [
      ...
      },
      {
        ...
        position: [-5.005764, 21.063457, -4.213575],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1.183397, 1.183397, 1.183397],
        metadata: {
          name: '',
          mass: 0,
          restitution: 0.1,
  ...
  [TrackSegmentType.y02]: {
    ...
    partList: [
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [3.06838, 17.300013, -2.331263],
        rotationQuaternion: [0, 0, 0, 1],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [5.168382, 17.300013, -0.23125],
        rotationQuaternion: [0, -0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [0.968381, 17.300013, -0.231252],
        rotationQuaternion: [0, 0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [3.068361, 17.300013, 1.868748],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [-3.031618, 17.300013, -2.331264],
        rotationQuaternion: [0, 0, 0, 1],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [-0.931617, 17.300013, -0.23125],
        rotationQuaternion: [0, -0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [-5.131618, 17.300013, -0.231252],
        rotationQuaternion: [0, 0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [-3.031638, 17.300013, 1.868748],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/pipe_180_B_yellow.gltf',
        position: [-5.099998, 7.100008, -0.200013],
        rotationQuaternion: [-0.5, -0.5, -0.5, 0.5],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/pipe_180_B_yellow.gltf',
        position: [-5.109821, 3.100007, -0.200013],
        rotationQuaternion: [-0.50000001, 0.49999999, 0.5, 0.5],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'yellow/pipe_90_B_yellow.gltf',
        position: [-2.99999, 17.100008, -0.200029],
        rotationQuaternion: [-0.70710682, 1.8e-7, 0.70710674, 1.8e-7],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'yellow/pipe_90_B_yellow.gltf',
        position: [3.00001, 17.100008, -0.200029],
        rotationQuaternion: [0.70710668, -1.8e-7, 0.70710688, 1.8e-7],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'yellow/pipe_90_B_yellow.gltf',
        position: [7.000011, 13.100006, -0.200022],
        rotationQuaternion: [0.00000106, -0.70710785, -0.00000138, 0.70710571],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'yellow/pipe_180_B_yellow.gltf',
        position: [-5.009821, 11.100007, -0.200013],
        rotationQuaternion: [-0.50000001, 0.49999999, 0.5, 0.5],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/pipe_straight_B_yellow.gltf',
        position: [-3.099997, 3.100004, -0.200012],
        rotationQuaternion: [-0.70710678, 0.70710679, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/pipe_90_B_yellow.gltf',
        position: [5.000003, 3.100004, -0.200022],
        rotationQuaternion: [-0.49999872, -0.49999922, -0.5000015, 0.50000055],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'yellow/pipe_end_yellow.gltf',
        position: [3.00001, 16.900007, -0.200029],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1.199613, 1.199613, 1.199613],
        metadata: {
          name: '',
          mass: 0,
          restitution: 0.5,
      ...
      {
        path: 'yellow/pipe_end_yellow.gltf',
        position: [-2.99999, 16.900007, -0.200029],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1.194607, 1.336598, 1.194607],
        metadata: {
          name: '',
          mass: 0,
          restitution: 0.5,
      ...
      {
        path: 'yellow/pipe_straight_B_yellow.gltf',
        position: [5.000001, 3.100004, -0.200012],
        rotationQuaternion: [-0.70710678, 0.70710679, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/arch_yellow.gltf',
        position: [2.660528, 1.266547, -0.190229],
        rotationQuaternion: [0, -0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/arch_yellow.gltf',
        position: [-2.704514, 1.266547, -0.190229],
        rotationQuaternion: [0, -0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/pillar_1x1x1.gltf',
        position: [4.80249, 1, -0.237169],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_4x2x1_yellow.gltf',
        position: [0, 0, 3.999943],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.118372, 2.999993, -3.790729],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.118372, 4.998979, -3.790729],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.118372, 6.998979, -3.790729],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.118372, 8.998973, -3.790729],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.118372, 10.994423, -3.790729],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.118372, 12.994407, -3.790729],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.118372, 14.994396, -3.790729],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_2x2x2_yellow.gltf',
        position: [0.118372, 16.919014, -3.790729],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_decorative_1x1x1_yellow.gltf',
        position: [0.102062, 17.439722, -4.790729],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.018372, 2.999992, 3.70927],
        rotationQuaternion: [0, -3e-8, 0, 1],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.018372, 6.998979, 3.70927],
        rotationQuaternion: [0, -3e-8, 0, 1],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.018372, 4.998979, 3.70927],
        rotationQuaternion: [0, -3e-8, 0, 1],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.018372, 8.998973, 3.70927],
        rotationQuaternion: [0, -3e-8, 0, 1],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.018372, 10.994423, 3.70927],
        rotationQuaternion: [0, -3e-8, 0, 1],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.018372, 12.994407, 3.70927],
        rotationQuaternion: [0, -3e-8, 0, 1],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_C.gltf',
        position: [0.018372, 14.994396, 3.70927],
        rotationQuaternion: [0, -3e-8, 0, 1],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_2x2x2_yellow.gltf',
        position: [0.018372, 16.919014, 3.70927],
        rotationQuaternion: [0, -3e-8, 0, 1],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_decorative_1x1x1_yellow.gltf',
        position: [0.034682, 17.439722, 4.70927],
        rotationQuaternion: [0, -3e-8, 0, 1],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/structure_A.gltf',
        position: [-0.032134, 21.473976, -0.064287],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: 'in',
      ...
      {
        path: 'neutral/barrier_4x1x1.gltf',
        position: [-0.011861, 18.919014, 3.227842],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/barrier_4x1x1.gltf',
        position: [-0.0168, 18.919014, -3.767718],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
  ...
  // [TrackSegmentType.r01]: {
  //   version: 1,
  //   rootFolderName: 'kay-platformer-pack',
  //   partList: [
  //     {
  //       path: 'neutral/pillar_1x1x4.gltf',
  //       position: [1.4, 0, -1.396034],
  //       rotationQuaternion: [0, 1, 0, 0],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  ...
  //     {
  //       path: 'neutral/structure_A.gltf',
  //       position: [0.000001, 8.499998, -0.000183],
  //       rotationQuaternion: [0, 1, 0, 0],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: 'in',
  ...
  //     },
  //     {
  //       path: 'red/platform_slope_6x2x2_red.gltf',
  //       position: [0, 0, -2.100004],
  //       rotationQuaternion: [0, -1e-7, 0, 1],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  //         mass: 0,
  ...
  //     {
  //       path: 'red/platform_slope_6x2x2_red.gltf',
  //       position: [2.1, 0, 0.000044],
  //       rotationQuaternion: [0, -0.70710538, 0, 0.70710818],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  //         mass: 0,
  ...
  //     {
  //       path: 'red/platform_slope_6x2x2_red.gltf',
  //       position: [-2.100034, 0.000001, 0.000145],
  //       rotationQuaternion: [0, 0.70710678, 0, 0.70710678],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  ...
  //     {
  //       path: 'red/platform_slope_6x2x2_red.gltf',
  //       position: [-0.00064, 0, 2.1],
  //       rotationQuaternion: [0, -1, 0, 5.1e-7],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  //         mass: 0,
  ...
  //       position: [0.000001, 3.999995, -0.000183],
  //       rotationQuaternion: [0, 1, 0, 0],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  ...
  //     },
  //     {
  //       path: 'red/platform_arrow_4x4x1_red.gltf',
  //       position: [-0.000007, 2.253897, 4.733078],
  //       rotationQuaternion: [-0.38268343, -1e-8, 0, 0.92387953],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  //         mass: 0,
  ...
  //     },
  //     {
  //       path: 'red/platform_decorative_1x1x1_red.gltf',
  //       position: [0.009327, 0.251426, 3.645966],
  //       rotationQuaternion: [0, 1, 0, 0],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  ...
  //     {
  //       path: 'red/platform_decorative_1x1x1_red.gltf',
  //       position: [3.666434, 0.251426, -0.02981],
  //       rotationQuaternion: [0, -0.7071068, 0, 0.70710676],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  ...
  //     {
  //       path: 'red/platform_arrow_4x4x1_red.gltf',
  //       position: [4.753546, 2.253897, -0.020476],
  //       rotationQuaternion: [-0.27059807, 0.65328144, 0.27059807, 0.6532815],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  //         mass: 0,
  ...
  //     {
  //       path: 'red/platform_decorative_1x1x1_red.gltf',
  //       position: [0.090659, 0.251426, -3.522453],
  //       rotationQuaternion: [0, 5e-8, 0, 1],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  //         mass: 0,
  ...
  //     {
  //       path: 'red/platform_arrow_4x4x1_red.gltf',
  //       position: [0.099993, 2.253897, -4.609564],
  //       rotationQuaternion: [-3e-8, -0.92387952, -0.38268346, 3e-8],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  //         mass: 0,
  ...
  //     {
  //       path: 'red/platform_arrow_4x4x1_red.gltf',
  //       position: [-4.718028, 2.253897, -0.020476],
  //       rotationQuaternion: [-0.27059811, -0.65328154, -0.27059809, 0.65328138],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  //         mass: 0,
  ...
  //     {
  //       path: 'red/platform_decorative_1x1x1_red.gltf',
  //       position: [-3.630916, 0.251426, -0.011143],
  //       rotationQuaternion: [0, 0.70710674, -2e-8, 0.70710683],
  //       scaling: [1, 1, 1],
  //       metadata: {
  //         name: '',
  //         mass: 0,
  ...
  [TrackSegmentType.end]: {
    ...
    partList: [
      {
        path: 'neutral/platform_wood_1x1x1.gltf',
        position: [-2.392719, 1, 16.756315],
        rotationQuaternion: [0, -0.89799014, 0, 0.44001558],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'neutral/sign.gltf',
        position: [2.065981, 1, 15.657379],
        rotationQuaternion: [0, 0.92387952, 0, 0.38268347],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'neutral/cone.gltf',
        position: [-1.542656, 1.405295, 15.602947],
        rotationQuaternion: [0, 0.96639354, 0, 0.25706718],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'neutral/pillar_2x2x2.gltf',
        position: [4.892064, 7.100006, -10.177377],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'blue/flag_B_blue.gltf',
        position: [-5.296139, 10.483843, 9.869092],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_4x2x2_yellow.gltf',
        position: [4, 6.100006, -6.200153],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [1.910881, 1.929642, 24.056309],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [-4.389118, 1.929642, 24.056309],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'green/flag_A_green.gltf',
        position: [-5.296139, 10.483843, -2.278313],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [6.610877, 1.929642, 21.156307],
        rotationQuaternion: [0, 0.70710679, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'neutral/structure_A.gltf',
        position: [-0.068214, 11.853444, -8.734509],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: 'in',
      ...
      },
      {
        ...
        position: [2.999995, 6.100006, 3.800017],
        rotationQuaternion: [0, -0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_1x1x1_yellow.gltf',
        position: [3.353307, 1.50002, 19.664999],
        rotationQuaternion: [-0.04651622, -0.70557511, -0.70557511, 0.04651622],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [5.000007, 0, 16.000011],
        rotationQuaternion: [0, -0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1.033135],
        metadata: {
          name: '',
          mass: 0,
          restitution: 0.5,
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [4.010879, 1.929642, 24.056309],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [-5, 0, 16.000027],
        rotationQuaternion: [0, 0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1.006775],
        metadata: {
          name: '',
          mass: 0,
          restitution: 0.5,
      ...
      {
        path: 'yellow/platform_4x4x1_yellow.gltf',
        position: [4.000075, 6.100006, -9.200002],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [-4.98912, 1.929642, 19.056307],
        rotationQuaternion: [0, 0.70710679, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [-4.98912, 1.929642, 23.256306],
        rotationQuaternion: [0, 0.70710679, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [6.610877, 1.929642, 16.956308],
        rotationQuaternion: [0, 0.70710679, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      },
      {
        ...
        position: [2.999997, 6.100006, 9.800017],
      ...
      {
        path: 'blue/platform_1x1x1_blue.gltf',
        position: [-5.296139, 9.483843, 9.869105],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/floor_wood_1x1.gltf',
        position: [3.034096, 1, 22.026995],
        rotationQuaternion: [0, -0.92387953, 0, 0.38268343],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'red/platform_2x2x4_red.gltf',
        position: [6.000009, 0, 25.00017],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [6.610877, 1.929642, 14.856309],
        rotationQuaternion: [0, 0.70710679, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/cone.gltf',
        position: [-1.542656, 1.199432, 15.602947],
        rotationQuaternion: [0, 0.93738975, -1e-8, 0.34828216],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'red/platform_1x1x1_red.gltf',
        position: [3.531904, 3.053544, 19.026873],
        rotationQuaternion: [0, 0.97772264, 0, 0.20990103],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      },
      {
        ...
        position: [-5.296139, 9.483843, -2.278297],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [-5.000001, 0, 22.000011],
        rotationQuaternion: [0, 0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1.001572],
        metadata: {
          name: '',
          mass: 0,
          restitution: 0.5,
      ...
      {
        path: 'yellow/platform_2x2x4_yellow.gltf',
        position: [-5.000002, 8.000005, -10.100003],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [-2.08912, 1.929642, 12.356277],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [3, 0, 14.000016],
        rotationQuaternion: [0, 0, 0, 1],
        scaling: [1, 1, 1.009425],
        metadata: {
          name: '',
          mass: 0,
          restitution: 0.5,
      ...
      {
        path: 'yellow/platform_4x4x1_yellow.gltf',
        position: [-4.000001, 6.100006, -9.199998],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [-4.98912, 1.929642, 21.156307],
        rotationQuaternion: [0, 0.70710679, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'green/platform_1x1x1_green.gltf',
        position: [3.406072, 2.053556, 19.093081],
        rotationQuaternion: [0, -0.9979095, 1e-8, 0.06462681],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [-2.28912, 1.929642, 24.056309],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/pillar_1x1x1.gltf',
        position: [-3.453334, 0.999697, 20.870079],
        rotationQuaternion: [0, 0.99567074, 0, 0.09295039],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      },
      {
        ...
        position: [-2.999999, 8.000008, -8.200006],
      ...
      {
        path: 'yellow/platform_slope_6x6x4_yellow.gltf',
        position: [3.000058, 8.000309, -8.200006],
        rotationQuaternion: [0, 0, 0, 1],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'blue/platform_1x1x1_blue.gltf',
        position: [3.263941, 1.053556, 18.996506],
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [-4.189118, 1.929642, 12.356277],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [2.11088, 1.929642, 12.356277],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/flag_A_yellow.gltf',
        position: [-5.097606, 12.000005, -10.154332],
        rotationQuaternion: [0, 0.70710681, 0, 0.70710676],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [0.01088, 1.929642, 12.356277],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/strut_horizontal.gltf',
        position: [-3.136523, 1.2, 21.654766],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/floor_wood_1x1.gltf',
        position: [3.187208, 1, 17.585615],
        rotationQuaternion: [0, -0.9944075, 0, 0.10561118],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [-4.98912, 1.929642, 16.956308],
        rotationQuaternion: [0, 0.70710679, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'red/platform_slope_6x6x4_red.gltf',
        position: [-3.000058, 6.100006, 3.800016],
        rotationQuaternion: [0, 0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [6.610877, 1.929642, 19.056307],
        rotationQuaternion: [0, 0.70710679, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [3.000045, 0, 23.99999],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1.006873],
        metadata: {
          name: '',
          mass: 0,
          restitution: 0.5,
      ...
      {
        path: 'yellow/platform_slope_6x6x4_yellow.gltf',
        position: [-3.099999, 8.000309, -8.100007],
        rotationQuaternion: [0, 0.70710679, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'red/flag_A_red.gltf',
        position: [-5.296139, 10.483843, 3.737333],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'blue/platform_slope_6x6x4_blue.gltf',
        position: [-3.000027, 6.100006, 9.800014],
      ...
      {
        path: 'neutral/pillar_2x2x2.gltf',
        position: [-5.050277, 7.100006, -10.20799],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'red/star_red.gltf',
        position: [3.025751, 2.063444, 22.069635],
        rotationQuaternion: [1e-8, -0.70710678, 0.70710678, 1e-8],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'yellow/platform_4x2x2_yellow.gltf',
        position: [-0.000002, 6.100006, -6.200068],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_slope_6x6x4_yellow.gltf',
        position: [3.100055, 8.000309, -8.100007],
        rotationQuaternion: [0, -0.70710681, 0, 0.70710676],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/strut_horizontal.gltf',
        position: [-3.132919, 1.2, 22.162041],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/strut_horizontal.gltf',
        position: [-3.167574, 1.628972, 21.879347],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [4.210878, 1.929642, 12.356277],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/floor_wood_1x1.gltf',
        position: [3.00634, 1.5, 22.086695],
        rotationQuaternion: [0, -0.92387954, 0, 0.38268342],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'green/platform_slope_6x6x4_green.gltf',
        position: [-3.000011, 6.100006, -2.199924],
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [6.610877, 1.929642, 23.256306],
        rotationQuaternion: [0, 0.70710679, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [5, 0, 21.999996],
        rotationQuaternion: [0, -0.70710678, 0, 0.70710678],
        scaling: [1, 1, 1.021407],
        metadata: {
          name: '',
          mass: 0,
          restitution: 0.5,
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [-2.999979, 0, 14.000025],
        rotationQuaternion: [0, 0, 0, 1],
        scaling: [1, 1, 1.015144],
        metadata: {
          name: '',
          mass: 0,
          restitution: 0.5,
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [-0.18912, 1.929642, 24.056309],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'neutral/bomb.gltf',
        position: [-3.148882, 1.2, 15.693774],
        rotationQuaternion: [-0.20503298, 0.97875506, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
          mass: 0,
      ...
      {
        path: 'yellow/platform_slope_6x2x2_yellow.gltf',
        position: [-2.999992, 0, 23.999998],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1.001981],
        metadata: {
          name: '',
          mass: 0,
          restitution: 0.5,
      ...
      {
        path: 'yellow/railing_straight_double_yellow.gltf',
        position: [-4.98912, 1.929642, 14.856309],
        rotationQuaternion: [0, 0.70710679, 0, 0.70710678],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      {
        path: 'red/platform_1x1x1_red.gltf',
        position: [-5.296139, 9.483843, 3.737328],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: '',
      ...
      },
      {
        ...
        position: [-0.066802, 8.983207, 9.913215],
        rotationQuaternion: [0, 1, 0, 0],
        scaling: [1, 1, 1],
        metadata: {
          name: 'end',
